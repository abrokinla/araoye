...
import { BarChart3, Linkedin, Github, Mail, ArrowDown } from "lucide-react";
...
function DataAnalystHero() {
  ...
  return (
    <section id="hero-data-analyst" className="w-full bg-background text-foreground">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid min-h-[calc(100vh-4rem)] items-center gap-8 lg:grid-cols-2">
          <div className="order-2 space-y-6 lg:order-1">
            <div className="space-y-4">
              <span className="font-semibold uppercase tracking-wider text-primary">Data Analyst</span>
              ...
              <p className="max-w-2xl text-lg text-foreground/80 md:text-xl">
                I uncover trends, patterns, and insights from complex datasets to drive informed business decisions. I transform raw data into clear, actionable, and visually compelling stories.
              </p>
            </div>
